...
try {
    ...
    $transactionDesc= $mpesaConfig['transaction_desc'] ?? 'Ticket Payment';
    ...
    if (empty($seats) || !is_array($seats)) {
        throw new Exception('Select at least one seat before initiating payment.');
    }
    ...
    $payload = [
        ...
        'AccountReference'  => mb_substr($accountRef ?: $route ?: 'Ticket', 0, 12),
        'TransactionDesc'   => mb_substr($transactionDesc ?: $route ?: 'Ticket Payment', 0, 32)
    ];
